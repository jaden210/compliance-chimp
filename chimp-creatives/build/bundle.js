...
const AdCreative = () => {
  ...
  const ctaStart = scene3End;
  const logoScale = (0,esm.spring)({ frame, fps, from: 0, to: 1, durationInFrames: 20 });
  const logoOpacity = (0,esm.interpolate)(frame, [0, 15], [0, 1], { extrapolateRight: "clamp" });
  const headlineY = (0,esm.spring)({ frame: frame - 10, fps, from: 60, to: 0, durationInFrames: 25 });
  const headlineOpacity = (0,esm.interpolate)(frame, [10, 25], [0, 1], { extrapolateRight: "clamp" });
  const chimpX = (0,esm.spring)({ frame: frame - 20, fps, from: 300, to: 0, durationInFrames: 30 });
  const chimpOpacity = (0,esm.interpolate)(frame, [20, 35], [0, 1], { extrapolateRight: "clamp" });
  const features = [
    "Automated Compliance Tracking",
    "Real-Time Team Monitoring",
    "Instant Audit Reports"
  ];
  const scene3Opacity = (0,esm.interpolate)(frame, [scene3Start, scene3Start + 15], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const scene3Y = (0,esm.spring)({
  ...
  const ctaOpacity = (0,esm.interpolate)(frame, [ctaStart, ctaStart + 15], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  ...
  const ctaPulse = frame > ctaStart + 20 ? 1 + 0.03 * Math.sin((frame - ctaStart - 20) * 0.15) : ctaScale;
  const gradientAngle = (0,esm.interpolate)(frame, [0, 450], [135, 180], {
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      ...
      children: [
        ...
        frame < scene2End && /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          esm.AbsoluteFill,
          {
            style: {
              opacity: frame > scene1End ? (0,esm.interpolate)(frame, [scene1End, scene1End + 15], [1, 0], { extrapolateRight: "clamp" }) : 1
            },
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    esm.Img,
                    {
                      src: (0,esm.staticFile)("complianceChimpLogo.png"),
                      style: { height: 50 }
                    }
                  )
                }
                    ...
                    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                      "h1",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.orange }, children: "Made Simple." })
                        ]
                      }
                    ),
                    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    esm.Img,
                    {
                      src: (0,esm.staticFile)("chimpThumbsup.png"),
                      style: { height: 480 }
                    }
                  )
                }
        ...
        frame >= scene2Start && frame < scene3End && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.AbsoluteFill,
          {
            style: {
              opacity: frame < scene2End ? (0,esm.interpolate)(frame, [scene2Start, scene2Start + 15], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp"
              }) : (0,esm.interpolate)(frame, [scene2End, scene2End + 15], [1, 0], {
                extrapolateRight: "clamp"
              }),
              justifyContent: "center",
              alignItems: "center"
            },
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 30 }, children: features.map((feature, i) => {
              const delay = scene2Start + 10 + i * 15;
              const featureOpacity = (0,esm.interpolate)(frame, [delay, delay + 15], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp"
              });
              const featureX = (0,esm.spring)({
                frame: frame - delay,
                fps,
                from: -80,
                to: 0,
        ...
        frame >= scene3Start && frame < ctaStart + 15 && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.AbsoluteFill,
          {
            style: {
              opacity: frame < ctaStart ? scene3Opacity : (0,esm.interpolate)(frame, [ctaStart, ctaStart + 15], [1, 0], {
                extrapolateRight: "clamp"
              }),
              justifyContent: "center",
              alignItems: "center",
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    "div",
                    {
                      ...
                      children: "Teams Trust Compliance Chimp"
                    }
                  ),
                  /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    "div",
        ...
        frame >= ctaStart && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.AbsoluteFill,
          {
            style: {
              opacity: ctaOpacity,
                  ...
                  /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                    "h2",
                    {
                      ...
                      children: [
                        "Ready to Simplify",
                        /* @__PURE__ */ (0,jsx_runtime.jsx)("br", {}),
                        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.orange }, children: "Compliance?" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ (0,jsx_runtime.jsx)(
...
const RoofingAds_BRAND = {
  blue: "#054d8a",
  darkBlue: "#032a4a",
  orange: "#ff9100",
  white: "#ffffff"
};
const adFade = (frame, start, end) => {
  const fadeIn = (0,esm.interpolate)(frame, [start, start + 12], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const fadeOut = (0,esm.interpolate)(frame, [end - 12, end], [1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return fadeIn * fadeOut;
};
const RoofingAdTemplate = ({ config }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const scene1Start = 0;
  const scene1End = fps * 4;
  ...
  const gradientAngle = (0,esm.interpolate)(frame, [0, scene4End], [132, 175], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const mascotX = (0,esm.spring)({
    frame: frame - 18,
    fps,
    from: 220,
    to: 0,
  ...
  const mascotOpacity = (0,esm.interpolate)(frame, [16, 30], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    ...
    {
      style: {
        background: `linear-gradient(${gradientAngle}deg, ${RoofingAds_BRAND.blue} 0%, #063f6e 52%, ${RoofingAds_BRAND.darkBlue} 100%)`,
        fontFamily: "'Nunito', 'Segoe UI', sans-serif",
        overflow: "hidden"
      },
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              right: -140,
              borderRadius: "50%",
              background: `radial-gradient(circle, ${RoofingAds_BRAND.orange}22 0%, transparent 70%)`,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              left: -180,
              borderRadius: "50%",
              background: `radial-gradient(circle, ${RoofingAds_BRAND.white}10 0%, transparent 72%)`,
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                esm.Img,
                {
                  ...
                  style: {
                    height: 52,
                    width: "auto",
                    opacity: (0,esm.interpolate)(frame, [0, 14], [0, 1], {
                      extrapolateRight: "clamp"
                    })
                  }
                }
              ),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { marginTop: 46, maxWidth: 760 }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "div",
                  {
                    style: {
                      color: RoofingAds_BRAND.orange,
                      fontWeight: 800,
                      fontSize: 24,
                      letterSpacing: 0.3,
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: (0,esm.staticFile)("chimpThumbsup.png"), style: { height: 368 } })
                }
              )
            ]
          }
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: "Real Roofing Risk Data"
                }
              ),
              config.proofStats.map((item, index) => {
                const rowStart = scene2Start + 8 + index * 10;
                const rowOpacity = (0,esm.interpolate)(frame, [rowStart, rowStart + 10], [0, 1], {
                  extrapolateLeft: "clamp",
                  extrapolateRight: "clamp"
                });
                const rowX = (0,esm.spring)({
                      ...
                      /* @__PURE__ */ (0,jsx_runtime.jsx)(
                        "div",
                        {
                          style: {
                            ...
                            height: 34,
                            borderRadius: "50%",
                            background: RoofingAds_BRAND.orange,
                            color: RoofingAds_BRAND.white,
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    "div",
                    {
                      ...
                      children: config.outcomes.map((outcome, index) => {
                        const lineStart = scene3Start + 6 + index * 8;
                        const lineOpacity = (0,esm.interpolate)(frame, [lineStart, lineStart + 10], [0, 1], {
                          extrapolateLeft: "clamp",
                          extrapolateRight: "clamp"
                        });
                        return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          esm.AbsoluteFill,
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: (0,esm.staticFile)("complianceChimpLogo.png"), style: { height: 58 } }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "h2",
                {
                  style: {
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
                    ...
                    fontWeight: 850,
                    fontSize: 34,
                    boxShadow: `0 10px 28px ${RoofingAds_BRAND.orange}66`,
                    transform: `scale(${1 + 0.02 * Math.sin((frame - scene4Start) * 0.18)})`
                  },
                  children: config.ctaButton
                }
              ),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
...
const fearLossConfig = {
  kicker: "Roofing Owner Alert",
  headline: "Protect Margin\nFrom OSHA Penalties",
  subheadline: "One citation can wipe out profit from multiple jobs.",
  proofStats: [
    "Fall Protection (1926.501) is OSHA's #1 most cited standard (FY2024).",
    "2025 max penalties: $16,550 serious | $165,514 willful or repeated.",
    "Roofing contractors recorded 110 fatal falls/slips/trips in 2023."
  ],
  proofSources: ["OSHA Top 10 FY2024", "OSHA 2025 penalty memo", "BLS TED May 2025"],
  outcomesTitle: "What small roofing teams need",
  outcomes: [
    "Send training by text to every crew member.",
    "Track completion automatically instead of spreadsheets.",
    "Keep inspection-ready records in one place."
  ],
...
const winWorkConfig = {
  ...
  subheadline: "When requests come in, respond with organized proof in minutes.",
  proofStats: [
    "Roofing had 110 fatal falls/slips/trips in 2023 (26.0% of construction total).",
    "Fall Protection is #1 and Ladders are #3 on OSHA's FY2024 cited list.",
    "OSHA Safety Pays notes indirect injury costs are usually uninsured."
  ],
  proofSources: ["BLS TED May 2025", "OSHA Top 10 FY2024", "OSHA Safety Pays background"],
  outcomesTitle: "Built for small roofing operations",
  outcomes: [
    "Centralize training logs and safety documentation.",
    "Reduce scramble time before inspections or requests.",
    "Show disciplined safety process to protect opportunities."
  ],
  ctaTitle: "Get roofing documentation under control.",
  ctaButton: "Get OSHA-Ready Now",
  ctaFooter: "No credit card required to start"
};
const crewProtectionConfig = {
  kicker: "Crew Safety First",
  headline: "Protect Your Crew\nWithout Admin Chaos",
  subheadline: "Simple workflows that help teams train, track, and stay ready.",
  proofStats: [
    "Roofing contractors had the most construction fall/slip/trip deaths in 2023: 110.",
    "OSHA lists Fall Protection Training (1926.503) in the FY2024 top 10.",
    "2025 OSHA max serious penalty is $16,550 per violation."
  ],
  proofSources: ["BLS TED May 2025", "OSHA Top 10 FY2024", "OSHA 2025 penalty memo"],
  outcomesTitle: "Practical for field crews",
  outcomes: [
    "Deliver training by text and email.",
    "Use repeatable safety reminders across jobs.",
    "Be ready if OSHA shows up tomorrow."
  ],
  ctaTitle: "Protect people. Protect profit. Start today.",
  ctaButton: "Start Free Trial",
  ctaFooter: "Compliance Chimp for Roofing Contractors"
};
const RoofingFearLossCreative = () => /* @__PURE__ */ (0,jsx_runtime.jsx)(RoofingAdTemplate, { config: fearLossConfig });
const RoofingWinWorkCreative = () => /* @__PURE__ */ (0,jsx_runtime.jsx)(RoofingAdTemplate, { config: winWorkConfig });
const RoofingCrewProtectionCreative = () => /* @__PURE__ */ (0,jsx_runtime.jsx)(RoofingAdTemplate, { config: crewProtectionConfig });
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "chimp-creatives:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkchimp_creatives"] = self["webpackChunkchimp_creatives"] || [];
